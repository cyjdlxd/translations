...
> 加载数据很简单：执行命令 **[manage.py loaddata](https://docs.djangoproject.com/en/2.0/ref/django-admin/#django-admin-loaddata) &lt fixturename &gt** ，其中 **&lt fixturename &gt** 是你创建的夹具文件的名字。 
